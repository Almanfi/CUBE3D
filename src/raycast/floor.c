...
void    cast_floor(t_cub3d *cub3d)
{
    ...
    ceiling_color = ((cub3d->texture.ceiling.r << 16) + (cub3d->texture.ceiling.g << 8) + cub3d->texture.ceiling.b);
    while (rows < WINDOW_HEIGHT)
    {
        ...
        {   
            ...
            cub3d_pixel_put(cub3d, columns, WINDOW_HEIGHT - rows - 1, ceiling_color);
            columns++;
        }
        rows++;
    }
